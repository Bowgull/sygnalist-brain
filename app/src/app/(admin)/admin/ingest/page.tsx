          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[12px] text-[#9CA3AF]">
                Pull jobs from labeled emails (ZipRecruiter, LinkedIn, Indeed, Glassdoor)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-5">
          <div className="mb-4 space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[12px] text-[#B8BFC8]">Inserts into staging inbox for review</span>
            </div>
          </div>

          <div className="mb-4 rounded-xl bg-[#0C1016] p-3">
            <p className="text-[11px] font-semibold uppercase tracking-wider text-[#6B7280]">Required Env Vars</p>
            <div className="mt-2 space-y-1 font-mono text-[11px] text-[#9CA3AF]">
              <p>GMAIL_CLIENT_ID</p>
              <p>GMAIL_CLIENT_SECRET</p>
              <p>GMAIL_REFRESH_TOKEN</p>
            </div>
          </div>
          ...
          {result && (
            <div className="mt-3 rounded-xl bg-[#6AD7A3]/10 p-3">
              <p className="text-[13px] font-medium text-[#6AD7A3]">{result.message}</p>
              <p className="text-[12px] text-[#9CA3AF]">Jobs ingested: {result.jobs_ingested}</p>
            </div>
          )}
