...
export default function AdminIngestPage() {
  ...
  const reviewTotal = counts.pending + counts.ready;
      ...
      {activeTab === "ingest" && (
        <>
          ...
          {pendingReview > 0 && (
            <button
              onClick={() => setActiveTab("review")}
              className="flex w-full items-center gap-3 rounded-2xl border border-[#FAD76A]/20 bg-[#FAD76A]/5 px-4 py-3 text-left transition hover:bg-[#FAD76A]/10"
            >
              ...
              <div>
                ...
                <p className="text-[11px] text-[#9CA3AF]">Tap to review and approve</p>
              </div>
              ...
              {result && (
                <div className="mt-3 rounded-xl bg-[#6AD7A3]/10 p-4">
                  ...
                  {result.jobs_new > 0 && (
                    <button
                      onClick={() => setActiveTab("review")}
                      className="mt-3 w-full rounded-lg bg-[#FAD76A]/10 px-3 py-2 text-[12px] font-medium text-[#FAD76A] transition hover:bg-[#FAD76A]/20"
                    >
                      Review {result.jobs_new} new job{result.jobs_new !== 1 ? "s" : ""} →
                    </button>
                  )}
                </div>
              )}
